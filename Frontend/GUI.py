...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when", "why", "whose", "whom", "can you", "what's", "where's", "how's"]
...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        self.gif_label.setAlignment(Qt.AlignBottom | Qt.AlignBottom)
...
class CustomTopBar(QWidget):
    ...
    def showMessageScreen(self):
        ...
        message_screen = MessagesScreen(self)
